import { GEOTIMELINE_ERA_IDS, getGeoTimelineEra } from './geoTimelineRegistry.js';
...
function freezeGeoNarrative(geoNarrative) {
  ...
  return Object.freeze({
    ...
    timelineEraId: getGeoTimelineEra(geoNarrative.timelineEraId)?.id || null,
...
export const GeoNarrativeRegistry = Object.freeze({
  journey_to_bethlehem: freezeGeoNarrative({
    ...
    timelineEraId: GEOTIMELINE_ERA_IDS.lifeOfChrist,
  ...
  life_of_david: freezeGeoNarrative({
    id: 'life_of_david',
    timelineEraId: GEOTIMELINE_ERA_IDS.unitedKingdom,
    title: 'Life of David',
  ...
  road_to_emmaus: freezeGeoNarrative({ id: 'road_to_emmaus', timelineEraId: GEOTIMELINE_ERA_IDS.lifeOfChrist, title: 'Road to Emmaus', summary: 'A curated post-resurrection walk from Jerusalem toward Emmaus, with Emmaus shown cautiously because site identification is debated.', scriptureRefs: ['Luke 24:13-35'], routeMetadata: { routeType: 'overland', certainty: 'emmaus_identification_debated', activeByDefault: false, studioTemplate: true }, narration: { status: 'placeholder', cuePrefix: 'road_to_emmaus', audioReady: false }, languageHooks: {}, completionState: { status: 'available', completedWaypointIds: [] }, futureSyncChannels: Object.values(GEONARRATIVE_SYNC_CHANNELS), waypoints: [
  ...
  paul_first_missionary_journey: freezeGeoNarrative({
    ...
    timelineEraId: GEOTIMELINE_ERA_IDS.earlyChurch,
